...
.logout-section { padding: 40rpx 0 80rpx; display: flex; justify-content: center; }
.logout-btn { width: 80%; height: 80rpx; line-height: 80rpx; text-align: center; background: #fff; color: #ef4444; border: 1rpx solid #ef4444; border-radius: 40rpx; font-size: 28rpx; }
</style>
